...
//static char *font = "Fira Code:pixelsize=18:antialias=true:autohint=true, Font Awesome 5 Brands:pixelsize=18, Font Awesome 5 Free:pixelsize=18, Material Icons:pixelsize=18";
 ...
 * attribute.
 */
static unsigned int blinktimeout = 50;
